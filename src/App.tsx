...
export default function App() {
  ...
  return (
    <>
          ...
          <div className="method-layout">
            <div className="overview-card">
              <div className="figure-toolbar">
                <div>
                  <span>Figure 1</span>
                  <strong>CORE-DSE overview</strong>
                </div>
      ...
      <footer>
        <span>CORE-DSE</span>
        <p>Coarse extraction and refinement for directional speech extraction.</p>
      </footer>
